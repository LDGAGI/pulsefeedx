...
export const CTA = () => {
  ...
  return (
    <section className="py-48 md:py-64 w-full overflow-hidden relative z-30">
        ...
        <div className="mx-auto w-full relative z-20 sm:max-w-[40rem]  md:max-w-[48rem] lg:max-w-[64rem] xl:max-w-[80rem] bg-gradient-to-br from-slate-800 to-gray-900 dark:from-neutral-900 dark:to-neutral-950 sm:rounded-2xl">
          <div className="relative -mx-6   sm:mx-0 sm:rounded-2xl overflow-hidden px-6  md:px-8 ">
            ...
            <div className="relative px-6 pb-14 pt-20 sm:px-10 sm:pb-20 lg:px-[4.5rem]">
              ...
              <div className="relative z-10 mx-auto flex items-center justify-center mt-8">
                <Button
                  as={LocaleLink}
                  href={`/${locale}/demo/chat`}
                  className="shadow-lg shadow-blue-500/50 hover:shadow-blue-500/70 hover:scale-105 transition-all duration-200"
                >
                  {t('button')}
                </Button>
              </div>
